...
import { FileCheck, CheckCircle, AlertCircle, Search, Archive, Users, Activity, Settings, Trash2, Download, Eye, ArrowRight, X, XCircle, FileText, Loader2, TrendingUp, ExternalLink, Shield, History, Calendar, PieChart, Briefcase, Clock, DollarSign, User } from 'lucide-react';
...
function OperationStaffDashboard({ user, initialSection = 'statistics' }) {
    ...
    const headerSearchEnabled = ['project_management', 'bookings', 'withdrawals', 'commission', 'package_management', 'subscription_history'].includes(activeSection);
