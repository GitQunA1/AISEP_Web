...
export default function StartupBookings({ user }) {
    ...
    return (
        <div className={styles.section}>
            <div className={styles.card}>
                ...
                {loading ? (
                    ...
                    <div className={styles.emptyState}>
                        <Clock size={40} />
                        <p>Bạn chưa có lịch tư vấn nào.</p>
                    </div>
                ) : (
                                        ...
                                        {(booking.status === 2 || booking.status === 'Confirmed' || booking.status === 3 || booking.status === 'Completed') && (
                                            <>
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => setReportModal({ bookingId: booking.id, advisorName: booking.advisorName, userRole: 'Startup' })}
                                                >
                                                    <FileText size={14} />
                                                    Xem báo cáo
                                                </button>
            ...
            {/* ConsultingReportModal (View Only for Startup or interaction) */}
            {reportModal && (
